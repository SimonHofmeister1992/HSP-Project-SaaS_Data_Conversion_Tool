...
\lfoot{SaaS Kalenderdienste Datentransformation (privisorisch!!!) -- SS \the\year}
\cfoot{}
...
\begin{center}
	...
	\vspace*{1cm}
	\textbf{SaaS Datentransformation Kalenderdienste (provisorisch!!!)}\\
	\vspace*{1cm}
	...
	\begin{tabular}{rl}%{6cm}p{7.5cm}}
		...
		\rule{0mm}{5ex}\textbf{Leiter:} & Prof. Johannes Schildgen \\ 
